...
public class BarChartManager {
    ...
    public BarChartManager(BarChart mBarChart, Context mContext) {
     ...
     * 设置X轴属性
     */
    private void setChartXAxis(BarChart mBarChart, List<String> xValueList) {
        //自定义设置横坐标
...
//        xAxis.enableGridDashedLine(10f, 10f, 0f);
     ...
     * 设置Y轴的属性
     */
    private void setChartYAxis(BarChart mBarChart) {
