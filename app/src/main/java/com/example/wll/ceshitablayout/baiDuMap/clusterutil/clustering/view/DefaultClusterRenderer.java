...
package com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering.view;
...
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.ui.IconGenerator;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.projection.Point;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.projection.SphericalMercatorProjection;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
            //自定义局图标
            mIconGenerator.setBackground(MyApplication.context().getResources().getDrawable(R.mipmap.point));
