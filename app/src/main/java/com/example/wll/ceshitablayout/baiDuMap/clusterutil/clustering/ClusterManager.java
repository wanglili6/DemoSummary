package com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering;
...
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.MarkerManager;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering.algo.Algorithm;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering.view.ClusterRenderer;
import com.example.wll.ceshitablayout.baiDuMap.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements BaiduMap.OnMapStatusChangeListener, BaiduMap.OnMarkerClickListener{
    ...
    public ClusterManager(Context context, BaiduMap map, MarkerManager markerManager) {
        ...
        mRenderer = (ClusterRenderer<T>) new DefaultClusterRenderer<T>(context, map, this);
